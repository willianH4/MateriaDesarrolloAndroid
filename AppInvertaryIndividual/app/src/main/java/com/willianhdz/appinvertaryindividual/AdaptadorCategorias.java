...
public class AdaptadorCategorias extends
 RecyclerView.Adapter<AdaptadorCategorias.CategoriasViewHolder>{
...
//(AdaptorArticulos).
    public AdaptadorCategorias(Context mCtx, List<Categoria> categoriaList) {
        this.mCtx = mCtx;
...
*/
   ...
   //     Toast.LENGTH_SHORT).show();
        Categoria dto = categoriaList.get(position);
