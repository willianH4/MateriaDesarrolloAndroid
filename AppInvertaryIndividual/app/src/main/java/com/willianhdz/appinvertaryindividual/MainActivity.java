...
*/ ///////////////////////////Finaliza bloque del menu no usado
    ...
    public void bajaporcodigo(View v) {
        ...
        if(inputEt){
            ...
            if(conexion.bajaIdCategorias(MainActivity.this,datos)){
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.uno){
            ...
            Intent listViewActivity = new Intent(MainActivity.this, RecyclerviewCategorias.class);
            startActivity(listViewActivity);
            ...
            Intent listViewActivity = new Intent(MainActivity.this, Productos.class);
            startActivity(listViewActivity);
        }
    }
}